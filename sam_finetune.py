...
def main():
    sam_checkpoint = "/content/Detect-AnyShadow/checkpoints/sam_vit_b_01ec64.pth"
    model_type = "vit_b"
    device = "cuda"
    ...
    # load bounding boxes
    f = open("/content/Detect-AnyShadow/dataset/sam_train.json", "r")
    content = f.read()
    ...
    for epoch in range(num_epochs):
        ...
        for i, img_path in enumerate(img_all_pbar):
            ...
            if i % 100 == 0:
                ...
                cv2.imwrite(
                    "/content/Detect-AnyShadow/img_logs_sam/{}_{}.jpg".format(epoch, i),
                    _save,
                )
